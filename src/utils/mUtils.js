...
export const sandFormData = (url,formData,info)=>{
  ...
  return new Promise((resolve, reject) => {
    ...
    xhr.open("POST", `${info.baseURL}/app/uploadFile/${this.dialogType}`);
    xhr.send(formData);
  })
}
/**
...
//   console.log('routes>>>>>>>'+JSON.stringify(menuData));
//    for(var i = 0;i < menuData.length;i++){
//         const menuobj = menuData[i]
//         const component = menuData[i].component
//         if( component && component !== 'content'){
//             componentNew = require('pages/'+menuData[i].component+'.vue')
//         }else{
